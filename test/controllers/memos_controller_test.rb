...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { description: @memo.description, title: @memo.title, user_id: @memo.user_id } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { description: @memo.description, title: @memo.title, user_id: @memo.user_id } }
